...
class AnnotationScannerTest {
  ...
  fun wrongSetterParameter() {
    ...
    Truth.assertAbout<JavaSourcesSubject.SingleSourceAdapter, JavaFileObject>(JavaSourceSubjectFactory.javaSource())
      ...
      .failsToCompile()
      .withErrorContaining(
        "The setter method 'setA(java.lang.String)' for field 'a' in class test.WrongSetterParam must have exactly one parameter of type 'int'")
  }
  ...
  fun privateGetter() {
    ...
    Truth.assertAbout<JavaSourcesSubject.SingleSourceAdapter, JavaFileObject>(JavaSourceSubjectFactory.javaSource())
      ...
      .failsToCompile()
      .withErrorContaining(
        "The field 'a' in class test.PrivateGetter has private or protected visibility. Hence a corresponding getter method must be provided with minimum package visibility (or public visibility if this is a super class in a different package) with the name getA() or isA() in case of a boolean. Unfortunately, there is no such getter method. Please provide one!")
  }
  ...
  fun privateTextContent() {
    ...
    Truth.assertAbout<JavaSourcesSubject.SingleSourceAdapter, JavaFileObject>(JavaSourceSubjectFactory.javaSource())
      ...
      .failsToCompile()
      .withErrorContaining(
        "The field 'a' in class test.PrivateTextContent has private or protected visibility. Hence a corresponding getter method must be provided with minimum package visibility (or public visibility if this is a super class in a different package) with the name getA() or isA() in case of a boolean. Unfortunately, there is no such getter method. Please provide one!")
  }
  ...
  fun privateGetterTextContent() {
    ...
    Truth.assertAbout<JavaSourcesSubject.SingleSourceAdapter, JavaFileObject>(JavaSourceSubjectFactory.javaSource())
      ...
      .failsToCompile()
      .withErrorContaining(
        "The field 'a' in class test.TextContent has private or protected visibility. Hence a corresponding getter method must be provided with minimum package visibility (or public visibility if this is a super class in a different package) with the name getA() or isA() in case of a boolean. Unfortunately, there is no such getter method. Please provide one!")
  }
  ...
  fun privateBooleanField() {
    ...
    Truth.assertAbout<JavaSourcesSubject.SingleSourceAdapter, JavaFileObject>(JavaSourceSubjectFactory.javaSource())
      ...
      .failsToCompile().withErrorContaining(
        "The field 'a' in class test.BooleanField has private or protected visibility. Hence a corresponding getter method must be provided with minimum package visibility (or public visibility if this is a super class in a different package) with the name getA() or isA() in case of a boolean. Unfortunately, there is no such getter method. Please provide one!")
  }
