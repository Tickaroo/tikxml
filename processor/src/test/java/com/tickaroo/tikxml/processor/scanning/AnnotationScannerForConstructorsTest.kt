...
class AnnotationScannerForConstructorsTest {
  ...
  fun allConstructorParamsAnnotatedPublicVisibility1() {
    val componentFile = JavaFileObjects.forSourceLines("test.NoConstructorClass",
      ...
      "   public AnnotatedConstructorClass(@${Attribute::class.java.simpleName} int attribute) {} ",
  ...
  fun allConstructorParamsAnnotatedPackageVisibility1() {
    val componentFile = JavaFileObjects.forSourceLines("test.NoConstructorClass",
      ...
      "@${Xml::class.java.simpleName}",
      "class AnnotatedConstructorClass {",
      "   AnnotatedConstructorClass(@${Attribute::class.java.simpleName} int attribute) {}",
  ...
  fun allConstructorParamsAnnotatedPrivateVisibility1() {
    val componentFile = JavaFileObjects.forSourceLines("test.NoConstructorClass",
      ...
      "@${Xml::class.java.simpleName}",
      "class AnnotatedConstructorClass {",
      "   private AnnotatedConstructorClass(@${Attribute::class.java.simpleName} int attribute) {}",
      "}")
    ...
    Truth.assertAbout<JavaSourcesSubject.SingleSourceAdapter, JavaFileObject>(JavaSourceSubjectFactory.javaSource())
      ...
      .failsToCompile()
      .withErrorContaining(
        "The constructor AnnotatedConstructorClass(int) in class test.AnnotatedConstructorClass is annotated with TikXml annotations and therefore must have at least package visibility to be able to be invoked from TikXml")
  }
  ...
  fun notAllConstructorParamsAreAnnotated() {
    val componentFile = JavaFileObjects.forSourceLines("test.NoConstructorClass",
      ...
      "@${Xml::class.java.simpleName}",
      "class AnnotatedConstructorClass {",
      "   private AnnotatedConstructorClass(int a, @${Attribute::class.java.simpleName} int attribute) {}",
      "}")
    ...
    Truth.assertAbout<JavaSourcesSubject.SingleSourceAdapter, JavaFileObject>(JavaSourceSubjectFactory.javaSource())
      ...
      .failsToCompile()
      .withErrorContaining(
        "The constructor AnnotatedConstructorClass(int,int) in class test.AnnotatedConstructorClass contains a mix of TikXml annotated parameters and not annotated parameters. That is not allowed! Either annotate all parameters or none of them")
  }
  ...
  fun constructorsAndFieldsAnnotated1() {
    ...
    Truth.assertAbout<JavaSourcesSubject.SingleSourceAdapter, JavaFileObject>(JavaSourceSubjectFactory.javaSource())
      ...
      .failsToCompile()
      .withErrorContaining(
        "test.AnnotatedConstructorClass has TikXml annotated fields AND an annotated constructor AnnotatedConstructorClass(int). That is not allowed! Either annotate fields or a constructor (but not a mix of both)")
  }
  ...
  fun twoAnnotatedConstructors() {
    ...
    Truth.assertAbout<JavaSourcesSubject.SingleSourceAdapter, JavaFileObject>(JavaSourceSubjectFactory.javaSource())
      ...
      .failsToCompile()
      .withErrorContaining(
        "Only one constructor with TikXml annotated parameters is allowed but found multiple constructors with annotated parameters in class test.AnnotatedConstructorClass: 1) AnnotatedConstructorClass(int) 2) AnnotatedConstructorClass(java.lang.String)")
  }
  ...
  fun constructorsAndFieldsAnnotated2() {
    val componentFile = JavaFileObjects.forSourceLines("test.ItemConstructor",
      ...
      "   @${Attribute::class.java.canonicalName} String aString;",
      "   @${Attribute::class.java.canonicalName} int anInt;",
      "   @${Attribute::class.java.canonicalName} boolean aBoolean;",
      "   @${Attribute::class.java.canonicalName} double aDouble;",
      "   @${Attribute::class.java.canonicalName} long aLong;",
      "   @${Attribute::class.java.canonicalName} Integer intWrapper;",
      "   @${Attribute::class.java.canonicalName} Boolean booleanWrapper;",
      "   @${Attribute::class.java.canonicalName} Double doubleWrapper;",
      "   @${Attribute::class.java.canonicalName} Long longWrapper;",
      "",
      "   public ItemConstructor(@${Attribute::class.java.canonicalName} String aString, @${Attribute::class.java.canonicalName} int anInt, @${Attribute::class.java.canonicalName} boolean aBoolean, @${Attribute::class.java.canonicalName} double aDouble, @${Attribute::class.java.canonicalName} long aLong, @${Attribute::class.java.canonicalName} Integer intWrapper, @${Attribute::class.java.canonicalName} Boolean booleanWrapper, @${Attribute::class.java.canonicalName} Double doubleWrapper, @${Attribute::class.java.canonicalName} Long longWrapper) {",
    ...
    Truth.assertAbout<JavaSourcesSubject.SingleSourceAdapter, JavaFileObject>(JavaSourceSubjectFactory.javaSource())
      ...
      .failsToCompile()
      .withErrorContaining(
        "Conflict: field 'aString' in class test.ItemConstructor has the same xml attribute name 'aString' as the field 'aString' in class test.ItemConstructor. You can specify another name via annotations.")
  }
  ...
  fun booleanConstructorParameter1() {
    val componentFile = JavaFileObjects.forSourceLines("test.NoConstructorClass",
      ...
      "@${Xml::class.java.simpleName}",
      "class AnnotatedConstructorClass {",
      "   AnnotatedConstructorClass(@${Attribute::class.java.simpleName} boolean attribute) {}",
  ...
  fun booleanConstructorParameterWithIsPrefixInParameterName() {
    val componentFile = JavaFileObjects.forSourceLines("test.NoConstructorClass",
      ...
      "@${Xml::class.java.simpleName}",
      "class AnnotatedConstructorClass {",
      "   AnnotatedConstructorClass(@${Attribute::class.java.simpleName} boolean isAttribute) {}",
      "   boolean isAttribute() { return false; }",
      "}")
