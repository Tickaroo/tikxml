 ...
 */
public class CompanyNestedTypeAdapterWithoutAttribute extends DelegatingTypeAdapter<Company> {

  public CompanyNestedTypeAdapterWithoutAttribute() {
    this(true);
  }

  public CompanyNestedTypeAdapterWithoutAttribute(boolean shouldReadTextContent) {
