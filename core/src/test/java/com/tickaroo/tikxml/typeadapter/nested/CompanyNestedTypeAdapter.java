 ...
 */
public class CompanyNestedTypeAdapter extends DelegatingTypeAdapter<Company> {

  public CompanyNestedTypeAdapter() {
    this(true);
  }

  public CompanyNestedTypeAdapter(boolean shouldReadTextContent) {
