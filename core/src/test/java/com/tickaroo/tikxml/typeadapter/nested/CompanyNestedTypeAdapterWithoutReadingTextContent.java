 ...
 */
public class CompanyNestedTypeAdapterWithoutReadingTextContent extends DelegatingTypeAdapter<Company> {

  public CompanyNestedTypeAdapterWithoutReadingTextContent() {
    this(true);
  }

  public CompanyNestedTypeAdapterWithoutReadingTextContent(boolean shouldReadTextContent) {
    ...
    // Child Elements
    //
    childElementBinders.put("info", new NestedChildElementBinder<Company>(false) {
