 ...
 */
@Xml(name = "item")
public class PropertyItemWithGetterSetters {

  @PropertyElement private String aString;
  @PropertyElement private int anInt;
  @PropertyElement private boolean aBoolean;
  @PropertyElement private double aDouble;
  @PropertyElement private long aLong;
  @PropertyElement(converter = DateConverter.class) private Date aDate;
  @PropertyElement private Integer intWrapper;
  @PropertyElement private Boolean booleanWrapper;
  @PropertyElement private Double doubleWrapper;
  @PropertyElement private Long longWrapper;
  ...
  @Override public boolean equals(Object o) {
    ...
    if (!(o instanceof PropertyItemWithGetterSetters)) return false;

    PropertyItemWithGetterSetters that = (PropertyItemWithGetterSetters) o;
