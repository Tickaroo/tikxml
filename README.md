...
Latest snapshot `0.5.1-SNAPSHOT` available: 
...
```groovy
compile 'com.tickaroo.tikxml:annotation:0.5.1-SNAPSHOT'
compile 'com.tickaroo.tikxml:core:0.5.1-SNAPSHOT'

apt 'com.tickaroo.tikxml:processor:0.5.1-SNAPSHOT'
```
