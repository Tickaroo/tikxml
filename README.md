...
Latest snapshot `0.8.5-SNAPSHOT` available:
...
```groovy
compile 'com.tickaroo.tikxml:annotation:0.8.5-SNAPSHOT'
compile 'com.tickaroo.tikxml:core:0.8.5-SNAPSHOT'

apt 'com.tickaroo.tikxml:processor:0.8.5-SNAPSHOT'
```

For retrofit2:

```groovy
compile 'com.tickaroo.tikxml:retrofit-converter:0.8.5-SNAPSHOT'
```

Also, an [AutoValue](https://github.com/google/auto/tree/master/value) extension is available:

```groovy
apt 'com.tickaroo.tikxml:auto-value-tikxml:0.8.5-SNAPSHOT'
```
