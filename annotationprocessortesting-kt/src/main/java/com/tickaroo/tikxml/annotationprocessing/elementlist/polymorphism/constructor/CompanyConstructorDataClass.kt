 ...
 */
@Xml(name = "company")
data class CompanyConstructorDataClass(
        @param:PropertyElement val name: String?,
        @param:Element(typesByElement = [
            ElementNameMatcher(type = BossConstructorDataClass::class, name = "boss"),
            ElementNameMatcher(type = EmployeeConstructorDataClass::class, name = "employee")
        ])
