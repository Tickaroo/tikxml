...
@Xml
data class BookConstructorDataClass(
        @Attribute val id: Int,
        @PropertyElement val author: String,
        @PropertyElement val title: String,
        @PropertyElement val genre: String,
        @PropertyElement(name = "publish_date", converter = DateConverter::class) val publishDate: Date,
        @PropertyElement val price: Double,
